...
const grass = StyleSheet.create({
  ...
  label: { fontSize: 13, color: '#8A7C9C', fontWeight: '600' },
  cell: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  check: { fontSize: 17, color: '#fff', fontWeight: '800' },
});
...
const styles = StyleSheet.create({
  ...
  cheatActiveText: { fontSize: 19, fontWeight: '800', color: COLORS.primary },
  cheatActiveSub: { fontSize: 14, color: '#8A7C9C', marginTop: 4 },
  ...
  coinLabel: { fontSize: 15, color: '#8A7C9C', fontWeight: '600', marginBottom: 12 },
  coinRow: { flexDirection: 'row', gap: 8, marginBottom: 8 },
  coin: { fontSize: 30, opacity: 0.25 },
  coinActive: { opacity: 1 },
  coinCount: { fontSize: 17, fontWeight: '800', color: COLORS.text },
  coinFullText: { fontSize: 15, color: COLORS.warning, fontWeight: '700', marginTop: 8 },
  ...
  streakCount: { fontSize: 16, fontWeight: '700', color: COLORS.primary },
  progressBg: { height: 8, backgroundColor: '#E0E0E0', borderRadius: 12, overflow: 'hidden', marginTop: 4 },
  progressFill: { height: '100%', backgroundColor: COLORS.success, borderRadius: 12 },
  streakHint: { fontSize: 14, color: '#8A7C9C', marginTop: 8, textAlign: 'center' },
  ...
  useBtnDisabled: { backgroundColor: '#D4C5DC' },
  useBtnText: { fontSize: 18, fontWeight: '800', color: '#fff' },
  useBtnSub: { fontSize: 14, color: 'rgba(255,255,255,0.8)', marginTop: 4 },
  ...
  usedText: { fontSize: 17, fontWeight: '700', color: '#2E7D32' },
  usedSub: { fontSize: 14, color: '#4CAF50', marginTop: 4 },

  // 안내
  infoBox: { backgroundColor: '#FBF4F9', borderRadius: 24, padding: 16 },
  infoTitle: { fontSize: 16, fontWeight: '800', color: COLORS.text, marginBottom: 10 },
  infoText: { fontSize: 15, color: '#8A7C9C', marginTop: 4, lineHeight: 20 },
  ...
  historyInfo: { flex: 1 },
  historyMemo: { fontSize: 16, fontWeight: '700', color: COLORS.text },
  historyDate: { fontSize: 14, color: '#8A7C9C', marginTop: 2 },
  historyDelta: { fontSize: 19, fontWeight: '800' },
  ...
  emptySub: { fontSize: 15, color: '#8A7C9C', marginTop: 6 },
  ...
  previewLabel: { fontSize: 16, fontWeight: '700', color: '#D4C5DC', marginBottom: 4 },
  ...
  premiumBanner: {
    ...
    backgroundColor: '#FFE8EF', borderRadius: 26, padding: 18,
    marginHorizontal: 16, borderWidth: 1.5, borderColor: '#F5C99B',
  },
  premiumEmoji: { fontSize: 28 },
  premiumTitle: { fontSize: 17, fontWeight: '800', color: '#4A3A5C' },
  premiumDesc: { fontSize: 14, color: '#8A7C9C', marginTop: 2, flexShrink: 1 },
  premiumArrow: { fontSize: 20, color: '#F5C99B', fontWeight: '700' },
  ...
  confirmDesc: { fontSize: 16, color: '#8A7C9C', textAlign: 'center', lineHeight: 22, marginBottom: 12 },
  confirmCoins: { fontSize: 17, fontWeight: '700', color: COLORS.primary, marginBottom: 20 },
  confirmBtn: {
    backgroundColor: COLORS.primary,
    borderRadius: 22,
    paddingVertical: 17,
  ...
  confirmCancelText: { color: '#8A7C9C', fontSize: 17, fontWeight: '700' },
});
