            ...
            <>
              ...
              {needsMoreData ? (
                ...
                <View style={styles.warnBanner}>
                  <Text style={styles.warnText}>⚠️ 현재 평균 섭취가 목표보다 많아요</Text>
...
const styles = StyleSheet.create({
  ...
  settingsBtn: {
    backgroundColor: COLORS.purple + '20', borderRadius: 10,
    paddingHorizontal: 12, paddingVertical: 5,
  },
  settingsText: { fontSize: 12, color: COLORS.purple, fontWeight: '700' },
  emptyBtn: {
    backgroundColor: '#F5F7FA', borderRadius: 12, padding: 16, alignItems: 'center',
    borderWidth: 1.5, borderColor: '#E0E7EF', borderStyle: 'dashed',
  },
  emptyText: { fontSize: 14, color: '#78909C', fontWeight: '600' },
  weightRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 14 },
  weightBox: { flex: 1, alignItems: 'center', backgroundColor: '#F8FAFC', borderRadius: 14, paddingVertical: 12 },
  weightLabel: { fontSize: 11, color: '#78909C', fontWeight: '600', marginBottom: 4 },
  weightVal: { fontSize: 22, fontWeight: '900', color: COLORS.text },
  weightUnit: { fontSize: 13, fontWeight: '600', color: '#78909C' },
  arrowWrap: { alignItems: 'center' },
  arrowText: { fontSize: 20 },
  diffBadge: { fontSize: 11, color: COLORS.success, fontWeight: '700', marginTop: 2 },
  achievedBanner: {
    backgroundColor: '#E8F5E9', borderRadius: 12, padding: 14, alignItems: 'center',
  },
  achievedText: { fontSize: 15, fontWeight: '700', color: COLORS.success },
  infoBanner: {
    backgroundColor: '#E3F2FD', borderRadius: 12, padding: 12, marginBottom: 8,
  },
  infoText: { fontSize: 13, fontWeight: '700', color: '#1565C0' },
  infoSub: { fontSize: 11, color: '#1565C0', marginTop: 3, opacity: 0.8 },
  warnBanner: {
    backgroundColor: '#FFF3E0', borderRadius: 12, padding: 12, marginBottom: 8,
  },
  warnText: { fontSize: 13, fontWeight: '700', color: '#E65100' },
  warnSub: { fontSize: 11, color: '#E65100', marginTop: 3, opacity: 0.8 },
  tipBanner: {
    backgroundColor: '#E8F5E9', borderRadius: 12, padding: 10, marginBottom: 8,
  },
  tipText: { fontSize: 12, color: COLORS.success, fontWeight: '600' },
  predictionBox: {
    backgroundColor: COLORS.purple + '12', borderRadius: 14,
    padding: 14, marginBottom: 10, alignItems: 'center',
  },
  predictionMain: { fontSize: 14, color: COLORS.text, fontWeight: '600', textAlign: 'center' },
  predictionHighlight: { fontSize: 18, fontWeight: '900', color: COLORS.purple },
  predictionDate: { fontSize: 12, color: '#78909C', marginTop: 4 },
  ddayRow: { flexDirection: 'row', gap: 8, marginBottom: 10 },
  ddayBox: { flex: 1, backgroundColor: '#F8FAFC', borderRadius: 12, padding: 10, alignItems: 'center' },
  ddayLabel: { fontSize: 10, color: '#78909C', fontWeight: '600', marginBottom: 4 },
  ddayVal: { fontSize: 16, fontWeight: '800', color: COLORS.text },
  premiumHint: {
  ...
  graphLabel: { fontSize: 12, fontWeight: '600', color: '#78909C', marginBottom: 4 },
