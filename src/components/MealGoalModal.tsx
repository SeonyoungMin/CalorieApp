      ...
      <View style={styles.overlay}>
        <View style={styles.card}>
          <View style={styles.header}>
            <Text style={styles.title}>🍽️ 끼니별 목표 칼로리</Text>
          ...
          {[
            ...
            { label: '☀️ 점심', emoji: '점심', value: ln, setter: setLn },
...
const styles = StyleSheet.create({
  ...
  close: { fontSize: 20, color: '#78909C' },
  desc: { fontSize: 12, color: '#78909C', marginBottom: 20, lineHeight: 18 },
  row: {
    flexDirection: 'row', alignItems: 'center',
    justifyContent: 'space-between', marginBottom: 14,
  },
  mealLabel: { fontSize: 15, fontWeight: '600', color: COLORS.text },
  inputWrap: {
    flexDirection: 'row', alignItems: 'center',
  ...
  unit: { fontSize: 12, color: '#78909C' },
  totalRow: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    borderTopWidth: 1, borderTopColor: '#E8EDF2',
    paddingTop: 14, marginTop: 4, marginBottom: 20,
  },
  totalLabel: { fontSize: 14, fontWeight: '600', color: '#78909C' },
