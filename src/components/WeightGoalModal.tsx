      ...
      <View style={styles.overlay}>
        <View style={styles.card}>
          <View style={styles.header}>
            <Text style={styles.title}>⚖️ 목표 체중 설정</Text>
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    backgroundColor: '#FAFBFD', textAlign: 'center',
  },
  unit: { fontSize: 16, color: '#78909C', fontWeight: '600', width: 28 },
  diffRow: {
    flexDirection: 'row', justifyContent: 'space-between',
    backgroundColor: '#F5F7FA', borderRadius: 12,
    paddingHorizontal: 16, paddingVertical: 12, marginBottom: 20,
  },
  diffLabel: { fontSize: 14, color: '#78909C', fontWeight: '600' },
